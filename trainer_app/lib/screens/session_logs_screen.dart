...
class SessionLogsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (_) => SessionLogCubit(logService: services.log, trainerId: me.id),
...
class _LogTile extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final member = context.read<AppServices>().auth.getUser(log.memberId);
    return InkWell(
        ...
        child: Row(
          children: [
            Container(
              width: 40,
              height: 40,
              decoration: BoxDecoration(color: const Color(0xFFE50914).withValues(alpha: 0.1), borderRadius: BorderRadius.circular(10)),
              child: const Icon(Icons.videocam_outlined, color: Color(0xFFE50914)),
            ),
